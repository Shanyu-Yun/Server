...
std::string InetAddress::toIp()     const { return ip_; }
uint16_t    InetAddress::toPort()   const { return port_; }
std::string InetAddress::toIpPort() const { return ip_ + ":" + std::to_string(port_); }
